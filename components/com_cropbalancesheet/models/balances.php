...
class CropbalancesheetModelBalances extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_cropbalancesheet'))
		{
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			if (isset($item->expencetype))
			{

				$values    = explode(',', $item->expencetype);
				$textValue = array();
				...
				$item->expencetype = !empty($textValue) ? implode(', ', $textValue) : $item->expencetype;
			}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_CROPBALANCESHEET_SEARCH_FILTER_DATE_FORMAT"), "warning");
